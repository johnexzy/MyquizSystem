...
<html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <p>For Question that require images, you'll need to write these questions with MS WORD, convert then to a PDF file. Here you can cut out the questions in the form of images, and then get them uploaded. <br> Click <a href="uploadWizard.php"><b>Here</b></a> to upload images <p>
